...
public class ReviewController {
    ...
    public ResponseEntity<ReviewDto> createReview(@PathVariable(value = "pokemonId") int pokemonId, @RequestBody ReviewDto reviewDto){
        ...
        return new ResponseEntity<>(reviewService.crateReview(pokemonId,reviewDto), HttpStatus.CREATED);
    ...
    public List<ReviewDto> getReviewsByPokemonId(@PathVariable(value = "pokemonId") int pokemonId){
        ...
        return reviewService.getReviewsByPokemon(pokemonId);
    ...
    public ResponseEntity<String> deleteReview(@PathVariable("pokemonId") int pokemonId, @PathVariable("id") int reviewId){
        ...
        reviewService.deleteReviewId(pokemonId,reviewId);
